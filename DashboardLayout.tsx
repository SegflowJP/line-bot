...
import { LayoutDashboard, LogOut, PanelLeft, Users, History, Globe } from "lucide-react";
...
function getMenuItems(t: (key: any) => string) {
  return [
      ...
      <div className="relative" ref={sidebarRef}>
        ...
        >
          ...
          <SidebarFooter className="p-3">
            ...
            <button
              onClick={toggleLang}
              className="flex items-center gap-3 rounded-lg px-2 py-2 hover:bg-accent/50 transition-colors w-full text-left mb-2 group-data-[collapsible=icon]:justify-center"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                <span className="tracking-tight text-foreground">
                  {activeMenuItem?.label ?? t("dashboard")}
                </span>
              </div>
            </div>
            <button
